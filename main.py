...
gratchia_image = face_recognition.load_image_file("DrGratchia.png")
gratchia_face_encoding = face_recognition.face_encodings(gratchia_image)[0]

# Load a 4rd sample picture and learn how to recognize it.
irfan_image = face_recognition.load_image_file("irfan.png")
irfan_face_encoding = face_recognition.face_encodings(irfan_image)[0]

# Load a 5rd sample picture and learn how to recognize it.
fazi_image = face_recognition.load_image_file("fazi.png")
fazi_face_encoding = face_recognition.face_encodings(fazi_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    obama_face_encoding,
    biden_face_encoding,
    gratchia_face_encoding,
    irfan_face_encoding,
    fazi_face_encoding
]
known_face_names = [
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                print('Name is ', name , ' and time is', date_string)
                if name != old_name:
                	worksheet.write(count,0,name)
                	worksheet.write(count,1,date_string)
                	count += 1
                old_name=name
